 ...
 *
 * @see TTL_event for information about how event and TTL_event relate
 *
 ...
 *
 * @param internal_tensor internal_tensor A TTL_tensor describing the internal tensor.
 * @param external_tensor external_tensor A TTL_tensor describing the external tensor.
 ...
 *
 * @param internal_tensor A TTL_tensor describing the internal tensor.
 * @param external_tensor A TTL_tensor describing the external tensor.
 ...
 *
 * @param internal_tensor internal_tensor A TTL_tensor describing the internal tile.
 * @param external_tensor external_tensor A TTL_tensor describing the external tile.
 * @param event event_ptr A pointer to the event which describe the transfer.
 *
 ...
 * @brief Export the external tensor to the internal tensor returning when complete
 *
 * @param internal_tensor A TTL_tensor describing the internal tile.
 * @param external_tensor A TTL_tensor describing the external tile.
 *
 * Complete description of what not how here.
 */
template <typename INT_TENSORTYPE, typename EXT_TENSORTYPE>
