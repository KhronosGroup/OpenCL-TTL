...
struct TTL_io_tensors {
    ...
    TTL_sub_tensor<TENSORTYPE> imported_to;     ///< The TTL_int_sub_tensor_t that was most recently imported
    TTL_sub_tensor<TENSORTYPE> to_export_from;  ///< The TTL_int_sub_tensor_t that will be exported next
};