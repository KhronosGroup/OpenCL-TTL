...
#define __TTL_create_tensor_impl(TTL_scope, const_1, location, type, const_2)                                     \
     ...
     */                                                                                                           \
    static inline const __TTL_tensor_name(TTL_, const_, location, type, , _t) *__attribute__((overloadable))      \
     ...
     * @return A __TTL_tensor_name(TTL_, const_1, location, type, , _t) version of the input tensor               \
     */                                                                                                           \
    static inline const __TTL_tensor_name(TTL_, const_1, location, void, , _t) *__attribute__((overloadable))     \
...
#define __TTL_create_sub_tensor_impl(TTL_scope, const_1, location, type, const_2)                                     \
     ...
     */                                                                                                               \
    static inline __TTL_tensor_name(TTL_, const_, location, type, sub_, _t) *__attribute__((overloadable))            \
     ...
     * @return A __TTL_tensor_name(TTL_, const_1, location, type, , _t) version of the input tensor                   \
     */                                                                                                               \
    static inline const __TTL_tensor_name(TTL_, const_1, location, void, sub_, _t) *__attribute__((overloadable))     \
...
#define __TTL_create_create_tensor_functions(TTL_scope, const_1, location, type, sub, const_2)                      \
    ...
    __TTL_tensor_overloaded_name(TTL_create_, const_1, location, type, sub, )(TTL_scope(const_2 type *) const base, \
                                                                              const TTL_shape_t shape,              \
                                                                              const TTL_layout_t layout,            \
                                                                              const TTL_dim_t elem_size) {          \
