...
__TTL_typedef_tensor_t(TENSOR_ADDRESS, const_, TENSOR_LOCATION, TTL_TENSOR_TYPE,
                       const);  ///< @brief create TTL_const_int_tensor_t
 ...
 * and potentially a TTL_int_tensor_t to be safely case to a TTL_const_int_tensor_t.
 */
__TTL_create_tensor_impl(TENSOR_ADDRESS, , TENSOR_LOCATION,
                         TTL_TENSOR_TYPE, );  ///< @brief create TTL_create_int_tensor_impl
__TTL_create_tensor_impl(TENSOR_ADDRESS, const_, TENSOR_LOCATION, TTL_TENSOR_TYPE,
                         const);  ///< @brief create TTL_create_const_int_tensor_impl
 ...
 * and potentially a TTL_int_tensor_t to be safely case to a TTL_const_int_tensor_t.
 */
__TTL_create_sub_tensor_impl(TENSOR_ADDRESS, , TENSOR_LOCATION,
                             TTL_TENSOR_TYPE, );  ///< @brief create TTL_create_int_sub_tensor_impl
