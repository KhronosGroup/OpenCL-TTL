 ...
 */
static unsigned char l_in[1024 * 512];
static unsigned char l_out[1024 * 512];

void TTL_duplex_buffering(unsigned char *restrict ext_base_in, int external_stride_in,
