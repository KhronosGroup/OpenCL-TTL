 ...
 */
static unsigned char l_buff1[1024 * 512];
static unsigned char l_buff2[1024 * 512];
static unsigned char l_buff3[1024 * 512];

void TTL_simplex_buffering(unsigned char *restrict ext_base_in, int external_stride_in,
