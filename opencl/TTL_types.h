...
typedef unsigned int TTL_dim_t;  ///< The type used to hold the size of an object along any dimension
typedef int TTL_offset_dim_t;    ///< The type used to hold offsets and origins.
 ...
 * use TTL_event_t in a way that is more applicable to their platforms we
 * used TTL_event_t.  For OpenCL TTL_event_t is event_t.
 */
